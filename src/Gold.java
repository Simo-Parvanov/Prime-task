public class Gold extends BaseCard {
    ...
    public Gold(String nameOwner, double turnover, double valueOfPurchase) {
    ...
    public void setDiscountRate(double discountRate) {
        ...
        discountRate = 2;
        int extraDiscount = (int) this.getTurnover() / 100;
        if (discountRate + extraDiscount > 10) {
            discountRate = 10;
        } else {
            discountRate = discountRate + extraDiscount;
        }
